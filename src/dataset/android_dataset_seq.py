...
class Android_GNSS_Dataset_Seq(Dataset):
    ...
    def process_sample(self, data):
        ...
        prange_corr = -1*data['prange_corr'].to_numpy()
        ...
        multipath = data['multipath'].to_numpy()
        sigtype = data['sigtype'].to_numpy()
        cn0 = data['cn0'].to_numpy()
        
        features = res_los_android_features(prange, expected_prange, satXYZ, guess_XYZb, ref_local, multipath, sigtype, cn0)
