...
% IMU_metadata.AccelerometerSigma = 0.0100;
% IMU_metadata.GyroscopeSigma = 1.7500e-04;
% IMU_metadata.AccelerometerBiasSigma = 1.6700e-04;
% IMU_metadata.GyroscopeBiasSigma = 2.9100e-06;
% IMU_metadata.AverageDeltaT = 0.0024;

%% Read data
disp('-- Reading sensor data from file')
% IMU data
IMU_data = importdata('fgo_IMU_data.txt');
...
% GPS data
GPS_data = importdata('fgo_GNSS_pos.txt');
...
for measurementIndex = firstGPSPose:finalGPSPose
